      ...
      <View style={styles.container} >
        ...
        <View style={styles.main}> 
          ...
          <RectButton style={styles.cartaz2} onPress={handleNavigationToLoja}>
              <Image source={require("../../assets/botao1.png") } />
            </RectButton>
            <RectButton style={styles.cartaz2} onPress={handleNavigationToLoja}>
              <Image source={require("../../assets/botao2.png") } />
            </RectButton>
            <RectButton style={styles.cartaz2} onPress={handleNavigationToLoja}>
              <Image source={require("../../assets/botao3.png") } />
            </RectButton>
            <RectButton style={styles.cartaz2} onPress={handleNavigationToLoja}>
              <Image source={require("../../assets/botao4.png") } />
            </RectButton>
          </ScrollView>
          </View>          
        </View>
