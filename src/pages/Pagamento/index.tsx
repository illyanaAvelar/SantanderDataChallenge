    ...
    >
      <View style={styles.container} >
        ...
        <View style={styles.main}> 
          ...
          >
            <Picker.Item label="Um mês" value="um_mês" />
            <Picker.Item label="Dois meses" value="dois_meses" />
            <Picker.Item label="Três meses" value="tres_meses" />
          </Picker>


          <View style={styles.all}> 
            <RectButton style={styles.cartaz2} >
              <Image source={require("../../assets/grafico2.png") } />
            </RectButton>
            <RectButton style={styles.cartaz2} >
              <Image source={require("../../assets/grafico3.png") } />
            </RectButton>
          </View>          
        </View>
